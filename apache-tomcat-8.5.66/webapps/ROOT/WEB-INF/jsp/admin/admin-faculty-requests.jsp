                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" id="navbarDropdown">
                            <a class="dropdown-item"
                               href="/controller?command=showRequestsListOfFaculty&facultyId=${faculty.id}&sessionLocale=en">
                                <fmt:message key="navbar.English"/></a>
                            <a class="dropdown-item"
                               href="/controller?command=showRequestsListOfFaculty&facultyId=${faculty.id}&sessionLocale=uk">
                                ...
                                <td>
                                    <form
                                        ...
                                        <button class="btn btn-primary" type="submit"><fmt:message
                                                key="admin.requests_of_faculty.check_request"/></button>
                                    </form>
                                </td>
