                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" id="navbarDropdown">
                            ...
                            <a class="dropdown-item"
                               href="/controller?command=getSubmitRequestForm&sessionLocale=en&facultyId=${faculty.id}">
                                <fmt:message key="navbar.English"/></a>
                            <a class="dropdown-item"
                               href="/controller?command=getSubmitRequestForm&sessionLocale=uk&facultyId=${faculty.id}">
                    ...
                    <div class="card-body">
                        <form action="controller" method="post">
                            ...
                            <div class="form-group row">
                                <label for="first_name" class="col-md-4 col-form-label text-md-right"><fmt:message
                                        key="applicant.admission.requests.first.name"/></label>
                                <div class="col-md-6" id="first_name">
                                    ${applicant.applicantProfile.firstName}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="last_name" class="col-md-4 col-form-label text-md-right"><fmt:message
                                        key="applicant.admission.requests.last.name"/></label>
                            ...
                            <div class="form-group row">
                                <label for="email_address" class="col-md-4 col-form-label text-md-right"><fmt:message
                                        key="applicant.admission.requests.email"/></label>
                            ...
                            <div class="form-group row">
                                <label for="address" class="col-md-4 col-form-label text-md-right"><fmt:message
                                        key="applicant.admission.requests.address"/> </label>
                            ...
                            <div class="form-group row">
                                <label for="phone_number" class="col-md-4 col-form-label text-md-right"><fmt:message
                                        key="applicant.admission.requests.phone_number"/>
                                </label>
                            ...
                            <input type="hidden" id="applicantId" name="applicantId"
                                   value="<c:choose><c:when test="${not empty applicantId}">${applicantId}</c:when><c:otherwise>${applicant.id}</c:otherwise></c:choose>"/>
                            <input type="hidden" id="facultyId" name="facultyId"
                                   value="<c:choose><c:when test="${not empty facultyId}">${facultyId}</c:when><c:otherwise>${faculty.id}</c:otherwise></c:choose>"/>
