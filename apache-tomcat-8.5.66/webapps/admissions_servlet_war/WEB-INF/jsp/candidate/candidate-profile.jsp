                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" id="navbarDropdown">
                            <a class="dropdown-item"
                               href="/controller?command=applicantProfile&sessionLocale=en&applicantId=${faculty.id}">
                                <fmt:message key="navbar.English"/></a>
                            <a class="dropdown-item"
                               href="/controller?command=applicantProfile&sessionLocale=uk&applicantId=${faculty.id}">
...
<div class="container">
    <div class="row">
        ...
        <form class="form-inline ml-auto my-2 my-lg-0">
            <a class="btn btn-primary" href="/controller?command=applicantProfileEdit" role="button"><fmt:message
        ...
        <div>
            <img src="<c:url value="/resources/img/${applicantProfile.fileName}"/>"/>
        </div>
