...
<%@ taglib prefix="fn" uri="http://admissions-committee-servlet/functions" %>
<%@ page session="true" %>
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" id="navbarDropdown">
                            <a class="dropdown-item"
                               href="/controller?command=getApplicantRequestsList&sessionLocale=en&facultyId=${faculty.id}">
                                <fmt:message key="navbar.English"/></a>
                            <a class="dropdown-item"
                               href="/controller?command=getApplicantRequestsList&sessionLocale=uk&facultyId=${faculty.id}">
                                ...
                                <td align="center">
                                    <form
                                        ...
                                        <button class="btn btn-primary" type="submit"><fmt:message
                                                key="applicant.admission.requests.delete"/></button>
                                    </form>
