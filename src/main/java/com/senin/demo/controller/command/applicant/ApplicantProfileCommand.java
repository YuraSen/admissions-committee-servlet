...
public class ApplicantProfileCommand implements Command {
    static final Logger LOG = LoggerFactory.getLogger(ApplicantProfileCommand.class);
    private final ApplicantService applicantService;

    public ApplicantProfileCommand(ApplicantService applicantService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        return "WEB-INF/jsp/applicant/applicant-profile.jsp";
    }
}
